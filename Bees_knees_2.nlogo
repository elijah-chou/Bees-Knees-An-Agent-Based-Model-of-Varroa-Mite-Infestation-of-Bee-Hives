...
to setup
  ...
  ask bees [create-link-with one-of hives]
...
to setup_flowers
  ask n-of number_of_flowers patches [ set pcolor rgb 219 84 97 ]
  ask patches with [pcolor = rgb 219 84 97] [ask neighbors4 [set pcolor rgb 219 84 97]]
  ask n-of number_of_flowers patches [ set pcolor rgb 66 129 164 ]
  ask patches with [pcolor = rgb 66 129 164] [ask neighbors4 [set pcolor rgb 66 129 164]]
  ask n-of number_of_flowers patches [ set pcolor rgb 80 81 79 ]
  ask patches with [pcolor = rgb 80 81 79] [ask neighbors4 [set pcolor rgb 80 81 79]]
end
