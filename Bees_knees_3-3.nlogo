...
patches-own [flower? infestedPatch?]

bees-own [infested? sick? treated? dist-to-goal returning-to-hive? goal energy add-energy? add-food? my-hive age food]

hives-own [food percent-infested number-infested-eggs number-uninfested-eggs]
