...
globals [healthy-age sick-age healthy-energy sick-energy num-sick-bees num-safe-bees num-healthy-bees] ;initiated in setup

patches-own [flower? infestedPatch? time]

bees-own [infested? sick? treated? safe? dist-to-goal returning-to-hive? goal energy add-energy? add-food? my-hive age food t-oil]
...
to birth-larva
  ...
  if food > 10 [
    ...
    ifelse protected? = true [
      set num-safe-bees (total-bees-produced * 0.843)
