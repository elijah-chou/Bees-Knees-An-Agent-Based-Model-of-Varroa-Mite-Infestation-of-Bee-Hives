...
bees-own [fuel infected? dist-to-goal returning-to-hive? goal energy add-energy? my-hive age]
...
to update-goal
  ...
  [
    ...
    [ set goal my-hive set returning-to-hive? true]
    set heading (towards goal)
  ]
...
to bites-the-dust
  ...
  [
    ifelse age = 0 [die]
    [
      if random-float 1 < 0.0001 [set age age - 1]
    ]
  ]
end
