...
hives-own [food infestation-rate sp-oil th-oil mite-count pop-count protected? mite-1 mite-2 mite-3]
...
to go
  ...
  ask hives [
    ...
    set mite-count (mite-1 + mite-2 + mite-3)
...
to birth-larva
  ...
  if (food >= 10) and (ticks mod 100) = 0 [
    ...
    [
      ifelse mite-count < pop-count [ set infestation-rate mite-count / pop-count ]
    ...
    set mite-1 mite-2
    set mite-2 mite-3
    set mite-3 round(1.1 * mite-count)
]
end
