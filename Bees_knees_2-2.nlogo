...
bees-own [fuel infected? dist-to-goal returning-to-hive? goal energy add-energy?]

hives-own [food? percent-infected]
...
to update-infected-rate
  ask hives [set percent-infected count link-neighbors with [infected? = true] set label percent-infected]
